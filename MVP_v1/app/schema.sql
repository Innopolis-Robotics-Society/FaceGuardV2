...
--
-- Users and guests are unified into a single `users` table with a
-- `type` column ('permanent' | 'temporary') and a nullable `expires_at`
-- column (only set when type = 'temporary').
