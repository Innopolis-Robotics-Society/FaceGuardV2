...
During backlog refinement, we learned that some stories were too big and needed to be split into smaller PBIs. This made the Sprint scope clearer and easier to implement.
