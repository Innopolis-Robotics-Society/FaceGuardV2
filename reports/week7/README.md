...
> **Status note:** This file is a shared Week 7 deliverable across multiple Assignment 6 Parts.
> Sections below marked `TODO (Part N owner)` are placeholders for teammates working on those
> Parts. The sections for **Part 8** (final transition outcome) and **Part 10** (Sprint Review)
> are filled in below.
...
TODO (whole team — fill in before submission)

# Screenshots
TODO (Part 1 / Part 7 owner — Sprint milestone, final release, deployment evidence, example
reviewed issue-linked PR, other Week 7 evidence, from `images/`)
